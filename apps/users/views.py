...
from .serializers import LogoutSerializer, SignUpSerializer, UpdateUserInformation, UpdateUserPhotoSerializer, LoginSerializer, \
    LoginRefreshSerializer, ForgotPasswordSerializer, ResetPasswordSerializer, VerificationRequestSerializer
...
class UpdateUserPhotoView(APIView):
    ...
    def put(self, request, *args, **kwargs):
        serializer = UpdateUserPhotoSerializer(data=request.data)
